...
function ExtraServiceRow({label}) {
  return (
    <Flex borderWidth={"1px"} py={2} borderRadius={"10px"} px={2} lineHeight={"normal"} justifyContent={"space-between"} alignItems={"center"}>
        <FormCheckBox/>
        <Text fontWeight={"600"} fontSize={"20px"} color= "#c5c5c5" w={"200px"} overflow={"hidden"}>{label}</Text>
