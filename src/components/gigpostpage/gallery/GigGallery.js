  ...
  return (
    <Stack ml={4} >
      <InputRowGrid
        ...
        text={
          <Text m={{base:"0 auto",md:"0"}}>Get noticed by the right buyers with visual examples of your services.</Text>
        }
        input={
          <Flex gap={2} flexWrap={"wrap"} justifyContent={{base:"center",md:"flex-start",lg:"flex-start"}}>
            <ImagePicker
...
Capture buyers' attention with a video that showcases your service.
        ...
        input={
          <Box className="" display={"flex"} justifyContent={{base:"center",md:"flex-start",lg:"flex-start"}}>
            <ImagePicker
...
Show some of the best work you created in a document (PDFs only).
        ...
        input={
          <Flex className="" gap={2} flexWrap={"wrap"} justifyContent={{base:"center",md:"flex-start",lg:"flex-start"}}>
            <ImagePicker
